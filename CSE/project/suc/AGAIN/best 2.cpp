...
{
long ph,age;
char name[20],add[50],email[30],con[50],date[22];
}list;
 
char search[20],name[99];
FILE *fp, *ft;
int i,n,z,l,found;
...
printf("Current Date:");
scanf("%[^\n]",&list.date);
printf(".....Patient of Medicine department.....");
printf("\n");
...
printf("Current Date:");
scanf("%[^\n]",&list.date);
printf(".....Patient of Ophthalmology department.....");
printf("\n");
fwrite(&list,sizeof(list),1,fp);
printf("\n Successfully Added \n ");
}
...
printf("Current Date:");
scanf("%[^\n]",&list.date);
printf(".....Patient of Gynae department.....");
printf("\n");
fwrite(&list,sizeof(list),1,fp);
printf("\n Successfully Added \n ");
}
...
printf("Current Date:");
scanf("%[^\n]",&list.date);
printf(".....Patient of Surgery department.....");
printf("\n");
fwrite(&list,sizeof(list),1,fp);
printf("\n Successfully Added \n ");
}
...
printf("Current Date:");
scanf("%[^\n]",&list.date);
printf(".....Patient of Paediatrics department.....");
printf("\n");
fwrite(&list,sizeof(list),1,fp);
printf("\n Successfully Added \n ");
}
...
{
printf("\nName\t: %s\nAge\t: %ld\nPhone\t: %ld\nAddress\t: %s\nEmail\t: %s\nConsultant: %s\nDate: %s",list.name,list.age,list.ph,list.add,list.email,list.con,list.date);
found++;
}
}
fclose(fp);
...
{
printf("\n..::Name\t: %s\n..::Phone\t: %ld\n..::Address\t: %s\n..::Email\t: %s\n..::Consultant\t: %s\n..::Date\t: %s\n",list.name,list.ph,list.add,list.email,list.con,list.date);
found++;
if (found%4==0)
{
